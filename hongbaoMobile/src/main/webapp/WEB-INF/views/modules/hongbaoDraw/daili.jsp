...
<body style="overflow-y:scroll;">
    ...
    <div id="etDiv" class="all-contents">
		...
		<div class="fixed_left">
		 ...
		 <header>
		 		<a href="${ctx}/hongbaoDraw/shuoming">
                <div style="font-size: .13rem;line-height: .32rem;text-align: center;
					color: #fd4948;position: absolute;top: 0.95rem;right: 2%;width: 20%;height: .4rem;font-weight:600;
				background: url(${ctxStatic }/modules/hongbaoDraw/images/winning.png) 0 0 no-repeat;background-size: contain;z-index: 3;">
					佣金说明</div>
				</a>
            </header>
        <div class="wrap_1" style="height: 6.5rem;">
        	<div style="width:90%; margin:0.8rem auto .8rem auto; text-align:center;color: red;">
			    <p><em>上图为您的专属二维码</em></p>
			    <p><em>长按图片保存到手机，分享获得推广佣金</em></p>
			    <img src="${ctx}/hongbaoDraw/userCode" width="100%" />
        	</div>
        </div>
