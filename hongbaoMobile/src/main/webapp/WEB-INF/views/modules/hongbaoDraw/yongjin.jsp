    ...
    <div id="etDiv" class="all-contents">
        ...
        <!--头部中奖记录与规则-->
            ...
            <div class="withdraw_deposit">
	            <div class="note_brokerage" style="height: 100%;">
                    <div class="brokerage_content"  style="height: 100%;">
                        <div class="note_bro">
                            <header class="note_header">
                                <h1>佣金记录（总：${yongjinSum}元）</h1>
                            </header>
                             <c:if test="${pageCount == 0}">
	                        	<div class="note_text">啊偶！这里还没有佣金记录哦~~~</div>
	                        </c:if>
	                        <c:if test="${pageCount > 0}">
		                        <div class="note_table">
		                            <table style="width: 90%;">
		                            	<c:forEach items="${pageList }" var="yongjin" varStatus="stat">
			                                <tr>
			                                	<td class="td-left">${fns:parseTimestamp(yongjin.createDate,'yyyy-MM-dd HH:mm:ss')}</td>
			                                	<td class="td-left">用户[${yongjin.userNoOrigin }]</td>
			                                    <td class="td-right">${yongjin.amount }元</td>
			                                </tr>
		                                </c:forEach>
		                            </table>
		                        </div>
