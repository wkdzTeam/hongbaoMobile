...
public class UUIDGenerator
{
    ...
    {
        return new StringBuffer(36).append(format(IP)).append(sep).append(format(JVM)).append(sep).append(format(getHiTime())).append(sep)
    ...
    public static void main(String[] args){
    	...
    	//402881ee5b7623cf015b7623cf900000
    }
}