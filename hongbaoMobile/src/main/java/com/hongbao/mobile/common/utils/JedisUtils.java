...
public class JedisUtils {
	 ...
	 * @return
	 */
	public static long setSet(String key, Set<String> value) {
	 ...
	 * @return 值
	 */
	public static Object getObjectMapValue(String mapKey,String key) {
		Object value = null;
		Map<String, Object> map = getObjectMap(mapKey);
		if(map!=null) {
			value = map.get(key);
		}
		return value;
	 ...
	 * @return
	 */
	public static String mapSetPut(String key, Map<String, String> value) {
		String result = null;
		//判断map是否存在
		if(exists(key)) {
			mapPut(key, value);
	 ...
	 * @return
	 */
	public static String mapObjectSetPut(String key, Map<String, Object> value) {
		String result = null;
		//判断map是否存在
		if(exists(key)) {
			mapObjectPut(key, value);
		} else {
			setObjectMap(key, value);
		}
		return result;
	}
