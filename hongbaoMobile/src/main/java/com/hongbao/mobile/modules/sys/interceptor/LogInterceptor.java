...
public class LogInterceptor extends BaseService implements HandlerInterceptor {
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, 
		...
		if (logger.isDebugEnabled()){
	        ...
	        String user_no = "";
	        if(object != null){
	        	UserInfo object_user = (UserInfo)object;
	        	user_no = object_user.getUserNo();
	        }
	        logger.debug((StringUtils.isNotBlank(user_no)?"用户编号【"+user_no+"】，":"")+"开始计时: {}  URI: {}",  new SimpleDateFormat("HH:mm:ss.SSS")
