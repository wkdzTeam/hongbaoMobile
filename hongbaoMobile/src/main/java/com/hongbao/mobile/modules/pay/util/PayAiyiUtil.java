...
/**
 * 爱益支付工具类
 * @ClassName PayAiyiUtil
 * @Description 
 */
public class PayAiyiUtil {
	
	public static Logger logger = LoggerFactory.getLogger(PayInfoService.class);

	/**
	 * 创建威富通转盘红包支付
	 * @Title createAiyiHongbaoDrawPay
	 * @Description 
	 * @param out_trade_no
	 * @param body
	 * @param attach
	 ...
	 */
	public static PayDataInfo createAiyiHongbaoDrawPay(String out_trade_no,String body,String attach,String sub_openid,Integer total_fee,Long createDate,String callbackParam) throws HongbaoException {
		PayConfig payConfig = PayUtil.getPayConfig();
		return createAiyiHongbaoDrawPay(payConfig,out_trade_no, body, attach, sub_openid, total_fee, createDate, callbackParam);
	}
	 ...
	 * @throws HongbaoException
	 */
	public static PayDataInfo createAiyiHongbaoDrawPay(PayConfig payConfig,String out_trade_no,String body,String attach,String sub_openid,Integer total_fee,Long createDate,String callbackParam) throws HongbaoException {
		return createAiyiPay(payConfig,out_trade_no, body, attach, sub_openid, total_fee, createDate, getDomainUrl(payConfig.getDrawAsyncNotifyUrl()), getDomainUrl(payConfig.getDrawSyncNotifyUrl()),callbackParam);
	}
	 ...
	 * @throws HongbaoException
	 */
	public static PayDataInfo createAiyiPay(PayConfig payConfig,String out_trade_no,String body,String attach,String sub_openid,Integer total_fee,Long createDate,String notify_url,String callback_url,String callbackParam) throws HongbaoException {
    	...
    	payDataInfo.setTokenId(tokenId);
		//支付地址
